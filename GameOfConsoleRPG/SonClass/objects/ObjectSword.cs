...
namespace GameOfConsoleRPG.SonClass.Objects
{
    public class ObjectSword : ObjectsOfGame
    {
        ...
        public int _damage;
        public ObjectSword(string name, string typeobjet, int lvl, bool damage, int valuedamage, bool reusable, int lvlusable, bool tresure, bool weapon, int x, int y, bool respawn, int expobj, bool healing,

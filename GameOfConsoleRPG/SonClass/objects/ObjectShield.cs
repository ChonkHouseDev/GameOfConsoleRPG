...
{
    public class ObjectShield : ObjectsOfGame
    {
        public bool Respawn;
        public int Expobj;
        public bool Healing;
        ...
        public int _damage;
        public ObjectShield(string name, string typeobjet, int lvl, bool damage, int valuedamage, bool reusable, int lvlusable, bool tresure, bool weapon, int x, int y, bool respawn, int expobj, bool healing,

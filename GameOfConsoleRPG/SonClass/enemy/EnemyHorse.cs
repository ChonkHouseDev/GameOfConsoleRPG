...
{
    public class EnemyHorse : Enemys
    {
        string Ability;
        ...
        public EnemyHorse(string name, int hp, int mana, string atk1, string atk2, int lvl, int x, int y, int velocx, int velocy, string ability, string simbolo,
        ...
        public void Ataque2()
        {
            ...
            Console.WriteLine("Golpe Patada");
        }
